...
export const step1Schema = z.object({
  tipo_hogar: z.enum(
    ...
    { message: 'Seleccione el tipo de hogar' }
  ),
  jefatura: z.enum(['femenina', 'masculina', 'compartida'], {
    message: 'Seleccione el tipo de jefatura',
  }),
  cant_personas: z
  ...
  tipo_barrio: z.enum(['formal', 'informal'], {
    message: 'Seleccione el tipo de barrio',
  }),
...
export type HogarSchemaType = z.input<typeof hogarSchema>;
